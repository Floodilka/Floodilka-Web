...
exports.sendMessage = asyncHandler(async (req, res) => {
  ...
  logger.debug('📨 Получен запрос на отправку DM:', { sender: req.user.id, receiver: receiverId });

  const message = await directMessageService.sendMessage(req.user.id, receiverId, content);
