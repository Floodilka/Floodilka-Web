...
import {
	...
	GIFT_CODE_BY_TRANSACTION_COLUMNS,
	GIFT_CODE_COLUMNS,
	type GiftCodeByCreatorRow,
	type GiftCodeByRedeemerRow,
	type GiftCodeByTransactionRow,
	type GiftCodeRow,
	...
	USER_BY_CLOUDPAYMENTS_SUBSCRIPTION_ID_COLUMNS,
	...
	type UserByEmailRow,
	type UserByPhoneRow,
	type UserByCloudpaymentsSubscriptionIdRow,
...
export const UserByUsername = defineTable<UserByUsernameRow, 'username' | 'user_id'>({
	name: 'users_by_username',
	columns: USER_BY_USERNAME_COLUMNS,
	primaryKey: ['username', 'user_id'],
});
...
export const UserByCloudpaymentsSubscriptionId = defineTable<
	UserByCloudpaymentsSubscriptionIdRow,
	'cloudpayments_subscription_id' | 'user_id'
>({
	name: 'users_by_cloudpayments_subscription_id',
	columns: USER_BY_CLOUDPAYMENTS_SUBSCRIPTION_ID_COLUMNS,
	primaryKey: ['cloudpayments_subscription_id', 'user_id'],
});
...
export const PaymentsByTransaction = defineTable<PaymentByTransactionRow, 'cloudpayments_transaction_id'>({
	name: 'payments_by_transaction',
	columns: PAYMENT_BY_TRANSACTION_COLUMNS,
	primaryKey: ['cloudpayments_transaction_id'],
});
...
export const GiftCodesByTransaction = defineTable<
	GiftCodeByTransactionRow,
	'cloudpayments_transaction_id' | 'code',
	'cloudpayments_transaction_id'
>({
	name: 'gift_codes_by_transaction',
	columns: GIFT_CODE_BY_TRANSACTION_COLUMNS,
	primaryKey: ['cloudpayments_transaction_id', 'code'],
	partitionKey: ['cloudpayments_transaction_id'],
});
