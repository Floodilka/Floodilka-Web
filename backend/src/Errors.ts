...
export * from './errors/BadGatewayError';
export * from './errors/BadRequestError';
export * from './errors/BannedFromGuildError';
export * from './errors/BotAlreadyInGuildError';
export * from './errors/BotBlockedByUserGuildRestrictionsError';
...
export * from './errors/BotUserAuthEndpointAccessDeniedError';
export * from './errors/BotUserAuthSessionCreationDeniedError';
export * from './errors/BotUserNotFoundError';
export * from './errors/CannotTransferOwnershipToBotError';
...
export * from './errors/InvalidResponseTypeForNonBotError';
export * from './errors/RedirectUriRequiredForNonBotError';
...
export * from './errors/WebhookVerificationError';
