...
export class UserRepository implements IUserRepositoryAggregate {
	...
	async findByCloudpaymentsSubscriptionId(cloudpaymentsSubscriptionId: string): Promise<User | null> {
		return this.accountRepo.findByCloudpaymentsSubscriptionId(cloudpaymentsSubscriptionId);
	}
	...
	async findGiftCodeByTransactionId(transactionId: number): Promise<GiftCode | null> {
		return this.contentRepo.findGiftCodeByTransactionId(transactionId);
	}
	...
	async getPaymentById(paymentId: string): Promise<Payment | null> {
		return this.contentRepo.getPaymentById(paymentId);
	}

	async getPaymentByTransactionId(transactionId: number): Promise<Payment | null> {
		return this.contentRepo.getPaymentByTransactionId(transactionId);
	}
}
