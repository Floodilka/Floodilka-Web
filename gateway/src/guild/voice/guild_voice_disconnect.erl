                ...
                true ->
                    ...
                    of
                        ...
                        {GuildId, ChannelId} ->
                            ...
                            NewState = cleanup_pending_voice_connection(ConnectionId, NewState0),
...
maybe_force_disconnect_async(GuildId, ChannelId, UserId, ConnectionId, State) ->
    case maps:get(test_force_disconnect_fun, State, undefined) of
        Fun when is_function(Fun, 4) ->
            Fun(GuildId, ChannelId, UserId, ConnectionId);
        _ ->
...
cleanup_pending_voice_connection(ConnectionId, State) ->
