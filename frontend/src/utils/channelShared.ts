...
export const filterViewableChannels = <T extends MinimalChannel>(channels: ReadonlyArray<T>): Array<T> =>
	channels.filter((channel) => VIEWABLE_CHANNEL_TYPES.has(channel.type));

export const pickDefaultGuildChannelId = ({
	guildId,
	channels,
	selectedChannelId,
	systemChannelId,
