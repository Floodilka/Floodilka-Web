...
export const Endpoints = {
	...
	AUTH_REGISTER_RESEND: '/auth/register/resend',
	...
	AUTH_FORGOT_VERIFY: '/auth/forgot/verify',
	...
	PAYMENTS_CHECKOUT_GIFT: '/payments/checkout/gift',
