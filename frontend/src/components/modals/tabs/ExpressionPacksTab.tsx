	...
	if (!hasPremium) {
		return (
			<div className={styles.emptyState}>
				<StatusSlate
					Icon={StickerIcon}
					title={<Trans>Expression Packs are a Premium feature</Trans>}
					description={<Trans>Create and share custom emoji and sticker packs with Floodilka Premium.</Trans>}
					actions={[
						{
							text: <Trans>Learn about Premium</Trans>,
