...
const getDescriptionDescriptor = (mode: VerificationMode, reverify = false): MessageDescriptor => {
	switch (mode) {
		case 'email':
			return reverify
				? msg`We've detected suspicious activity on your account. Please reverify your email address to continue using Флудилка.`
				: msg`We've detected suspicious activity on your account. Please verify your email address to continue using Флудилка.`;
		case 'phone':
			return reverify
				? msg`We've detected suspicious activity on your account. Please reverify your phone number to continue using Флудилка.`
				: msg`We've detected suspicious activity on your account. Please verify your phone number to continue using Флудилка.`;
		case 'email_or_phone':
			return reverify
				? msg`We've detected suspicious activity on your account. Please reverify your email address or phone number to continue using Флудилка.`
				: msg`We've detected suspicious activity on your account. Please verify your email address or phone number to continue using Флудилка.`;
	}
};
