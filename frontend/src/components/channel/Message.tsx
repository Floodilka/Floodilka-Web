...
import {FLOODILKABOT_ID, MessageEmbedTypes, MessagePreviewContext, MessageStates, MessageTypes} from '~/Constants';
...
export const Message: React.FC<MessageProps> = observer((props) => {
	...
	const messageClasses = clsx(
		...
		message.type === MessageTypes.CLIENT_SYSTEM && message.author.id === FLOODILKABOT_ID && styles.messageClientSystem,
