...
export const GuildChannelView = observer(({channelId, guildId, messageId}: GuildChannelViewProps) => {
	...
	useDocumentTitle(channel ? [channelTitlePart, guildTitlePart] : undefined);
				...
				<div className={styles.chatBlock}>
					...
					<div className={styles.emptyStateContent}>
						<div className={styles.centeredText}>
							...
							<p className={styles.voiceChannelDescription}>
								<Trans>This is a voice channel. Connect to start talking!</Trans>
							</p>
						</div>
						<div className={styles.buttonContainer}>
							<Button
								...
								fitContent
							>
								<Trans>Join Voice Channel</Trans>
							</Button>
						</div>
					</div>
				</div>
