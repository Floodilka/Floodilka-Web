...
import {FLOODILKABOT_ID, MessageEmbedTypes, MessageFlags, MessageStates, MessageTypes} from '~/Constants';
...
export const UserMessage = observer(() => {
	...
	if (message.type === MessageTypes.CLIENT_SYSTEM && message.author.id === FLOODILKABOT_ID) {
		return (
			<SpoilerSyncProvider>
