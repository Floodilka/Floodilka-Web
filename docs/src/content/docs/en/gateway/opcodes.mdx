...
| 5 | `VOICE_SERVER_PING` | C→S | Voice-server latency ping. |
...
| 13 | `CALL_CONNECT` | C↔S | Call-related control event (DMs, voice sessions). |
| 14 | `LAZY_REQUEST` | C→S | Lazy guild-member request by ranges. |
