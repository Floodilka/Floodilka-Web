...
func TestGuildMemberAvatar_Premium_TooLarge(t *testing.T) {
	...
	payload := map[string]any{
		"avatar": "data:image/png;base64," + getLargeBase64(AvatarMaxSize+10000),
	}
	...
	if resp.StatusCode == http.StatusOK {
		t.Error("expected request to fail for guild member avatar over size limit")
	}
}
