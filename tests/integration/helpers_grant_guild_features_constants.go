...
// Common guild feature constants
const (
	GuildFeatureBanner            = "BANNER"
	GuildFeatureAnimatedBanner    = "ANIMATED_BANNER"
	GuildFeatureInviteSplash      = "INVITE_SPLASH"
	GuildFeatureMoreEmoji         = "MORE_EMOJI"
	GuildFeatureMoreStickers      = "MORE_STICKERS"
	GuildFeatureUnlimitedEmoji    = "UNLIMITED_EMOJI"
	GuildFeatureUnlimitedStickers = "UNLIMITED_STICKERS"
